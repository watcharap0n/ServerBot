...
def chatbot_pipeline(
    X: list, y: list, message: str, X_test: Optional[list] = None
) -> dict:
    """
    ...
    if X_test:
        ...
        return {"accuracy": acc, "pred_prob": pred_prob, "predicted": predicted}
    message = list(message)
    predicted = text_clf_logis.predict(message)
    return {"predicted": predicted}


def chatbot_standard(
    X: list, y: list, message: str, X_test: Optional[list] = None
) -> dict:
    """
